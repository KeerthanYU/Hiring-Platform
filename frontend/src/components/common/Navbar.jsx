...
import { Bot, LogOut, User, Menu, X, Sparkles } from "lucide-react";
        ...
        <div className="hidden md:flex items-center space-x-4">
          {!isAuthenticated ? (
            ...
            <div className="flex items-center space-x-4">
              ...
              {user?.role === 'candidate' && (
                <Link to="/ai-analyzer" className="text-sm font-medium text-[var(--color-text-secondary)] hover:text-brand-violet transition-colors flex items-center gap-1">
        ...
        >
          ...
          {!isAuthenticated ? (
            ...
            <div className="flex flex-col space-y-4 pt-4 border-t border-[var(--color-border-primary)]">
              ...
              {user?.role === 'candidate' && (
                <Link to="/ai-analyzer" onClick={() => setIsOpen(false)} className="text-lg font-medium text-[var(--color-text-primary)] hover:text-brand-violet transition-colors flex items-center gap-2">
